...
const TRASH_ON_LEFT = sessionGet('exp2_children_vabove0_trash', () => Math.random() < 0.5);
...
/* ----------------------------------------------------------
   ...
   ---------------------------------------------------------- */
const CHAR_IMG_BASE  = '../adults - v above zero/img/';
...
const finnCleoScenarios = [
  {
    ...
    story_video: '../children-%20v%20above%200/videos%20v%20above%200/finn%20and%20cleo%20above%200.mp4'
  }
];
...
const secondBlockScenarios = [
  {
    ...
    story_video: '../children-%20v%20above%200/videos%20v%20above%200/milo%20and%20sasha%20above.mp4'
  },
  {
    id: 6,
    ...
    story_video: '../children-%20v%20above%200/videos%20v%20above%200/rex%20and%20zoe%20above%200.mp4'
  },
  {
    id: 7,
    ...
    story_video: '../children-%20v%20above%200/videos%20v%20above%200/kai%20and%20ruby%20above%200.mp4'
  },
  {
    id: 8,
    ...
    story_video: '../children-%20v%20above%200/videos%20v%20above%200/sam%20and%20ella%20v%20above%200.mp4'
  },
  {
    id: 9,
    ...
    story_video: '../children-%20v%20above%200/videos%20v%20above%200/andy%20and%20catherine%20v%20above%200.mp4'
  },
  {
    id: 10,
    ...
    story_video: '../children-%20v%20above%200/videos%20v%20above%200/harry%20and%20katie%20above%200.mp4'
  },
  {
    id: 11,
    ...
    story_video: '../children-%20v%20above%200/videos%20v%20above%200/nora%20and%20eric%20above%200.mp4'
  }
];
...
const scaleDemo1 = buildScaleDemoTrial(
  ...
  `${SHARED_BASE}Claire has some fault, but Michael has no fault..m4a`
);
...
const scaleDemo2 = buildScaleDemoTrial(
  ...
  `${SHARED_BASE}Michael has some fault, but Claire has no fault..m4a`
);
...
const scaleDemo3 = buildScaleDemoTrial(
  ...
  `${SHARED_BASE}Sometimes both people can be at fault, but one person can be more at fault than the other.m4a`,
  `${SHARED_BASE}Claire is more at fault than Michael..m4a`
);
...
const scaleDemo4 = buildScaleDemoTrial(
  ...
  `${SHARED_BASE}Claire and Michael are equally at fault..m4a`
);
...
const scaleDemo5 = buildScaleDemoTrial(
  ...
  `${SHARED_BASE}If neither Claire nor Michael is at fault.m4a`,
  `${SHARED_BASE}Neither Claire nor Michael is at fault..m4a`
);
...
function buildTestTrial(scenario, scenarioIdx, total) {
  ...
  const actorFirst = sessionGet('exp2_children_above0_checker_order_' + scenario.id, () => Math.random() < 0.5);
...
const shuffledAll = sessionGet('exp2_children_vabove0_shuffle_all',
...
(function () {
  ...
  const DATA_KEY = 'exp2_children_vabove0_debug_data';
