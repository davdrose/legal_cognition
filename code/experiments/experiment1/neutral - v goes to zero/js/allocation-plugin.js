      ...
      function vPanelHTML() {
        ...
        return `
          <div class="alloc-panel" id="v-panel">
            <img src="../adults - v goes to zero/img/${trial.v_img}" class="alloc-char-img" alt="${trial.v_name}">
      ...
      function trashPanelHTML() {
        return `
          <div class="alloc-panel" id="trash-panel">
            <img src="../adults - v goes to zero/img/cookie_jar.png" class="alloc-char-img" alt="The Cookie Jar">
        ...
        <div class="allocation-screen">
          ...
          ${trial.show_gate_question ? `
            <div id="gate-question" style="text-align:center; margin:0 0 6px 0;">
              <p style="font-size:18px; font-weight:600; margin:0 0 6px 0;">Do you think any cookies should be moved from ${trial.p_name}'s or ${trial.v_name}'s plates?</p>
          ...
          <div class="allocation-columns">
            ...
            <div class="p-pool-col">
              <img src="../adults - v goes to zero/img/${trial.p_img}" class="alloc-char-img" alt="${trial.p_name}">
