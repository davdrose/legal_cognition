...
const TRASH_ON_LEFT = sessionGet('neutral_trash', () => Math.random() < 0.5);
  ...
  return `
    <div class="two-person-display">
      <div class="person-col">
        <img src="../adults - v above zero/img/${imgFile}" class="char-img intro-img" alt="${name}">
...
function twoPersonHTML({ pCookies, vCookies, pLabel, vLabel, showSlots, showCookies, animate,
  ...
  return `
    <div class="two-person-display">
      <div class="person-col">
        <img src="../adults - v above zero/img/${pImg}" class="char-img" alt="${pName}">
      ...
      <div class="person-col">
        <img src="../adults - v above zero/img/${vImg}" class="char-img" alt="${vName}">
...
const finnCleoScenarios = [
  {
    ...
    story_slides: ['../adults - v above zero/img/trailppt/finn_cleo/finn_cleo_1.png','../adults - v above zero/img/trailppt/finn_cleo/finn_cleo_2.png','../adults - v above zero/img/trailppt/finn_cleo/finn_cleo_3.png','../adults - v above zero/img/trailppt/finn_cleo/finn_cleo_4.png','../adults - v above zero/img/trailppt/finn_cleo/finn_cleo_5.png','../adults - v above zero/img/trailppt/finn_cleo/finn_cleo_6.png','../adults - v above zero/img/trailppt/finn_cleo/finn_cleo_7.png','../adults - v above zero/img/trailppt/finn_cleo/finn_cleo_8.png','../adults - v above zero/img/trailppt/finn_cleo/finn_cleo_9.png','../adults - v above zero/img/trailppt/finn_cleo/finn_cleo_10.png','../adults - v above zero/img/trailppt/finn_cleo/finn_cleo_11.png']
  }
];
...
const secondBlockScenarios = [
  {
    ...
    story_slides: ['../adults - v above zero/img/trailppt/milo_sasha/milo_sasha_1.png','../adults - v above zero/img/trailppt/milo_sasha/milo_sasha_2.png','../adults - v above zero/img/trailppt/milo_sasha/milo_sasha_3.png','../adults - v above zero/img/trailppt/milo_sasha/milo_sasha_4.png','../adults - v above zero/img/trailppt/milo_sasha/milo_sasha_5.png','../adults - v above zero/img/trailppt/milo_sasha/milo_sasha_6.png','../adults - v above zero/img/trailppt/milo_sasha/milo_sasha_7.png','../adults - v above zero/img/trailppt/milo_sasha/milo_sasha_8.png']
  },
  {
    id: 6,
    ...
    story_slides: ['../adults - v above zero/img/trailppt/rex_zoe/rex_zoe_1.png','../adults - v above zero/img/trailppt/rex_zoe/rex_zoe_2.png','../adults - v above zero/img/trailppt/rex_zoe/rex_zoe_3.png','../adults - v above zero/img/trailppt/rex_zoe/rex_zoe_4.png','../adults - v above zero/img/trailppt/rex_zoe/rex_zoe_5.png','../adults - v above zero/img/trailppt/rex_zoe/rex_zoe_6.png','../adults - v above zero/img/trailppt/rex_zoe/rex_zoe_7.png']
  },
  {
    id: 7,
    ...
    story_slides: ['../adults - v above zero/img/trailppt/kai_ruby/kai_ruby_1.png','../adults - v above zero/img/trailppt/kai_ruby/kai_ruby_2.png','../adults - v above zero/img/trailppt/kai_ruby/kai_ruby_3.png','../adults - v above zero/img/trailppt/kai_ruby/kai_ruby_4.png','../adults - v above zero/img/trailppt/kai_ruby/kai_ruby_5.png','../adults - v above zero/img/trailppt/kai_ruby/kai_ruby_6.png','../adults - v above zero/img/trailppt/kai_ruby/kai_ruby_7.png','../adults - v above zero/img/trailppt/kai_ruby/kai_ruby_8.png','../adults - v above zero/img/trailppt/kai_ruby/kai_ruby_9.png']
  },
  {
    id: 8,
    ...
    story_slides: ['../adults - v above zero/img/trailppt/sam_ella/sam_ella_1.png','../adults - v above zero/img/trailppt/sam_ella/sam_ella_2.png','../adults - v above zero/img/trailppt/sam_ella/sam_ella_3.png','../adults - v above zero/img/trailppt/sam_ella/sam_ella_4.png','../adults - v above zero/img/trailppt/sam_ella/sam_ella_5.png','../adults - v above zero/img/trailppt/sam_ella/sam_ella_6.png','../adults - v above zero/img/trailppt/sam_ella/sam_ella_7.png','../adults - v above zero/img/trailppt/sam_ella/sam_ella_8.png','../adults - v above zero/img/trailppt/sam_ella/sam_ella_9.png']
  },
  {
    id: 9,
    ...
    story_slides: ['../adults - v above zero/img/trailppt/andy_catherine/andy_catherine_1.png','../adults - v above zero/img/trailppt/andy_catherine/andy_catherine_2.png','../adults - v above zero/img/trailppt/andy_catherine/andy_catherine_3.png','../adults - v above zero/img/trailppt/andy_catherine/andy_catherine_4.png','../adults - v above zero/img/trailppt/andy_catherine/andy_catherine_5.png','../adults - v above zero/img/trailppt/andy_catherine/andy_catherine_6.png','../adults - v above zero/img/trailppt/andy_catherine/andy_catherine_7.png','../adults - v above zero/img/trailppt/andy_catherine/andy_catherine_8.png']
  },
  {
    id: 10,
    ...
    story_slides: ['../adults - v above zero/img/trailppt/harry_katie/harry_katie_1.png','../adults - v above zero/img/trailppt/harry_katie/harry_katie_2.png','../adults - v above zero/img/trailppt/harry_katie/harry_katie_3.png','../adults - v above zero/img/trailppt/harry_katie/harry_katie_4.png','../adults - v above zero/img/trailppt/harry_katie/harry_katie_5.png','../adults - v above zero/img/trailppt/harry_katie/harry_katie_6.png','../adults - v above zero/img/trailppt/harry_katie/harry_katie_7.png','../adults - v above zero/img/trailppt/harry_katie/harry_katie_8.png']
  },
  {
    id: 11,
    ...
    story_slides: ['../adults - v above zero/img/trailppt/nora_eric/nora_eric_1.png','../adults - v above zero/img/trailppt/nora_eric/nora_eric_2.png','../adults - v above zero/img/trailppt/nora_eric/nora_eric_3.png','../adults - v above zero/img/trailppt/nora_eric/nora_eric_4.png','../adults - v above zero/img/trailppt/nora_eric/nora_eric_5.png','../adults - v above zero/img/trailppt/nora_eric/nora_eric_6.png','../adults - v above zero/img/trailppt/nora_eric/nora_eric_7.png']
  }
];
...
const warmupIntroFinn = {
  ...
  stimulus: `
    <div style="text-align:center; padding:30px 20px;">
      ...
      <img src="../adults - v above zero/img/michael.png" class="char-img intro-img" alt="Michael" style="margin:20px auto; display:block;">
...
const warmupIntroCleo = {
  ...
  stimulus: `
    <div style="text-align:center; padding:30px 20px;">
      ...
      <img src="../adults - v above zero/img/claire.png" class="char-img intro-img" alt="Claire" style="margin:20px auto; display:block;">
...
const warmupLayoutLocked = {
  ...
  harm_text: '',
  instruction_text: "If you think any cookies should be moved, you can decide how.",
  locked: true,
  is_practice: true,
  scenario_id: 0,
...
const warmupLayoutTwoWays = {
  ...
  trash_on_left: TRASH_ON_LEFT,
  harm_text: '',
  instruction_text: "Cookies can be moved in two ways.",
  locked: true,
  is_practice: true,
  scenario_id: 0,
  p_name: 'Michael', v_name: 'Claire',
...
const warmupWay1Locked = {
  ...
  trash_on_left: TRASH_ON_LEFT,
  harm_text: '',
  instruction_text: "<strong>First, you can move cookies by giving them to the other person.</strong><br><br>You can take Michael's cookies and give them to Claire, or take Claire's cookies and give them to Michael.<br><br>Let's try it out!",
  locked: true,
  is_practice: true,
  scenario_id: 0,
  p_name: 'Michael', v_name: 'Claire',
...
const warmupWay2Locked = {
  ...
  trash_on_left: TRASH_ON_LEFT,
  harm_text: '',
  instruction_text: "<strong>Second, you can move cookies by putting them in the cookie jar.</strong><br><br>If they go in the cookie jar, nobody gets them.<br>Let's try it out!",
  locked: true,
  is_practice: true,
  scenario_id: 0,
  p_name: 'Michael', v_name: 'Claire',
...
const warmupPracticeSummary = {
  ...
  trash_on_left: TRASH_ON_LEFT,
  harm_text: '',
  instruction_text: "Ok, so in our game you can decide that some cookies should be moved — you can give them to another person or put them in the cookie jar. Let's do both!",
  locked: true,
  is_practice: true,
  scenario_id: 0,
  p_name: 'Michael', v_name: 'Claire',
...
const shuffledAll = sessionGet('neutral_shuffle_all',
...
(function () {
  ...
  const DATA_KEY = 'neutral_debug_data';
